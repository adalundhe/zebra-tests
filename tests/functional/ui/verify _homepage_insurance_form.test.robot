...
Verify Homepage Form Exists
    ...
    Verify Element Attribute Matches  form_element=${crsf_input_field}  field_type=input  attribute=type  attribute_value=${csrf_field_type}
    ...
    Verify Element Attribute Matches  form_element=${zipcode_input_field}  field_type=input  attribute=type  attribute_value=text
    ...
    Verify Element Attribute Matches  form_element=${zipcode_form_button}  field_type=button  attribute=type  attribute_value=${button_type}
