...
Enter Data for First Questions and Submit
    ...
    Verify Text Attribute  field_type=input  attribute=value  attribute_value=${full_street_name} 
    ...
    Verify Text Attribute  field_type=input  attribute=value  attribute_value=${first_name}
